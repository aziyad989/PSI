        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Khotib Jumat</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                ...
                <div class="col-md-6">
                  ...
                  <div class="card card-success">
                    <div class="card-header">
                      <h3 class="card-title">Data Jumat</h3>
                    </div>
                    <!-- /.card-header -->
                    <!-- form start -->
...
<!--                         <div class="form-select-list">
                        ...
                        <div class="form-group">
                          <label for="NAMA_LENGKAP">Nama Imam</label>
                          <input type="text" class="form-control" id="NAMA_LENGKAP" name="NAMA_LENGKAP">
                        </div>
                         <div class="form-group">
                          <label for="TANGGAL_LAHIR">Nama Khotib</label>
                          <input type="text" class="form-control" id="TANGGAL_LAHIR" name="TANGGAL_LAHIR">
                        </div>
                         <div class="form-group">
                          <label for="ALAMAT">Nama Bilal</label>
                          <input type="text" class="form-control" id="ALAMAT" name="ALAMAT">
                        </div>
                         <div class="form-group">
                          <label for="NO_TELP">Nama Badal Khotib</label>
                          <input type="text" class="form-control" id="NO_TELP" name="NO_TELP">
                        </div>
                        <div class="form-group">
                          <label for="NO_TELP">Bulan</label>
                          <input type="text" class="form-control" id="NO_TELP" name="NO_TELP">
                        </div>
                        <div class="form-group">
                          <label for="NO_TELP">Minggu ke</label>
